...
<body>
    ...
    <div class="container">
    	<div class="row col-md-6 col-md-offset-2 custyle">
    		...
    		<thead>
    			<button onclick="location.href='${pageContext.request.contextPath}/sucursal/main'" class="btn btn-outline-dark pull-left">Ver todas las Sucursales</button>
				<tr>
	...
	<div class="container">
		<div class="row col-md-6 col-md-offset-2 custyle">
			<table id="table" class="table table-striped custab">
				<thead>
				<button onclick="location.href='${pageContext.request.contextPath}/empleado/nuevo?id=${sucursal.idSucursal}'" class="btn btn-outline-dark pull-left"><b>+</b> Registrar Empleado</button>
					<tr>
						<th class="text-center">Nombre</th>
